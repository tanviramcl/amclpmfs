<%@ Page Language="C#" MasterPageFile="~/UI/AMCLCommon.master" AutoEventWireup="true" CodeFile="FundTransactionEntry_withrecorddate.aspx.cs" Inherits="UI_FundTransactionEntry" Title="Fund Transaction Entry Form" %>
