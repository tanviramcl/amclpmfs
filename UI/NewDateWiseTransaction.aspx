<%@ Page Language="C#" MasterPageFile="~/UI/AMCLCommon.master" AutoEventWireup="true" CodeFile="NewDateWiseTransaction.aspx.cs" Inherits="DateWiseTransaction" Title="IAMCL Portfolio Market Price Update  (Design and Developed by Sakhawat)" %>
       ...
       <tr>
         ...
         <tr>
            ...
            <tr>
                ...
                <td align="left" width="200px">
                    <asp:TextBox ID="txtHowlaDateTo" runat="server" style="width:195px;" ontextchanged="HowlaDateTo_SelectedIndexChanged"
                CssClass="textInputStyle" TabIndex="7" AutoPostBack="true"   ReadOnly="false"
                ></asp:TextBox>
