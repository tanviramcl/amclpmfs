...
public partial class DateWiseTransaction : System.Web.UI.Page
{
    ...
    protected void HowlaDateTo_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (dt != null && dt.Rows.Count > 0)
        {
            ...
            if (!dt.Rows[0].IsNull("vch_dt"))
            {
                ...
                //  DateTime dtimeCurrentDate = DateTime.Now;
                DateTime? dtimeHowladateto, dtimetxtLastHowlaDate;
                string strHowladateto, strLastHowlaDate;

                if (!string.IsNullOrEmpty(txtHowlaDateTo.Text.Trim()))
                {
                    dtimeHowladateto = Convert.ToDateTime(txtHowlaDateTo.Text.ToString());

                    strHowladateto = dtimeHowladateto.Value.ToString("dd-MMM-yyyy");
                }
                else
                {
                    dtimeHowladateto = null;
                    strHowladateto = "";
                }


                if (!string.IsNullOrEmpty(txtLastHowlaDate.Text.Trim()))
                {
                    dtimetxtLastHowlaDate = Convert.ToDateTime(txtLastHowlaDate.Text.ToString());
                    strLastHowlaDate = dtimetxtLastHowlaDate.Value.ToString("dd-MMM-yyyy");
                }
                else
                {
                    dtimetxtLastHowlaDate = null;
                    strLastHowlaDate = "";
                }
                ...
                if (dtimeHowladateto <= dtimetxtLastHowlaDate)
                {
                ...
                {
                    txtHowlaDateTo.Text = strHowladateto;
                }
