...
public partial class UI_ReportViewer_NegativeBalanceCheckReportViewer : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        " (a.adc_rt - trunc(tcst_aft_com/tot_nos,2)) diff ,(round(a.adc_rt,2) - trunc(tcst_aft_com/tot_nos,2)) * trunc(tot_nos) gain from invest.pfolio_bk a, comp c " +
        " where c.comp_cd=a.comp_cd and f_cd="+fundcode+" and a.bal_dt_ctrl='"+Convert.ToDateTime(balancedate).ToString("dd - MMM - yyyy")+ "' and c.cds='Y' order by c.comp_nm)tab1 inner join invest.Fund f ON tab1.f_cd = f.f_cd order by  tab1.sect_maj_nm,tab1.CompanyName");
