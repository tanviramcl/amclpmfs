<%@ Page Language="C#"  MasterPageFile="~/UI/AMCLCommon.master" AutoEventWireup="true" CodeFile="NegativeBalanceCheckReport.aspx.cs" Inherits="UI_BalancechekReport" Title="Non Demate Shares Check" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="text-align: center">
        <tr>
            <td class="FormTitle" align="center">Negative Balance Check</td>
            <td>
                <br />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td align="left">
                <asp:DropDownList ID="p1dateDropDownList" runat="server" TabIndex="6"
                    OnSelectedIndexChanged="p1dateDropDownListNegativeBalanceCheck_SelectedIndexChanged">
                </asp:DropDownList>
            </td>
        </tr>
          <tr>
            ...
            <td align="left">
                <asp:DropDownList ID="p2dateDropDownList" runat="server" TabIndex="6"
                    OnSelectedIndexChanged="p2dateDropDownListNegativeBalanceCheck_SelectedIndexChanged">
                </asp:DropDownList>
            </td>
        </tr>
